        ...
        <main className="p-6 max-w-7xl mx-auto space-y-8">
              ...
              <CardContent className="p-6 flex items-start justify-between">
                <div>
                  ...
                  <p className="text-[#ba1a1a] text-xs font-medium flex items-center gap-1 mt-2">
                    <AlertTriangle size={14} />5 high priority
                  </p>
                </div>
                <div className="p-2 bg-[#dce9ff] rounded-lg text-[#0058be]">
                  <Bug size={20} />
          ...
          <section className="grid grid-cols-1 xl:grid-cols-3 gap-6 pb-8">
            <a href="/developer/project/1" className="block outline-none group">
              <Card className="bg-[#f8f9ff] border-[#c5c6cd] shadow-none hover:shadow-md transition-all flex flex-col cursor-pointer h-full">
                  ...
                  <div className="mt-auto space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-[#c5c6cd]">
                      <div className="flex -space-x-2">
                        ...
                        <div className="w-8 h-8 rounded-full border-2 border-[#f8f9ff] bg-[#d3e4fe] flex items-center justify-center text-xs font-medium text-[#0058be]">
                          +3
                        </div>
                      </div>
            ...
            <a href="/developer/project/3" className="block outline-none group">
              <Card className="bg-[#f8f9ff] border-b-4 border-b-[#0058be] border-[#c5c6cd] shadow-none hover:shadow-md transition-all flex flex-col h-full cursor-pointer">
                <CardContent className="p-6 flex flex-col h-full">
                  <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="mt-auto space-y-4">
                    <div>
                      ...
                      <div className="h-2 w-full bg-[#dce9ff] rounded-full overflow-hidden">
                        <div className="bg-[#0058be] h-full w-full rounded-full"></div>
                      </div>
                    </div>
                    <div className="flex items-center justify-between pt-4 border-t border-[#c5c6cd]">
                      <div className="flex -space-x-2">
